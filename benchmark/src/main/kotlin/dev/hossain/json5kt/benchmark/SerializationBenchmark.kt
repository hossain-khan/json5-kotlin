...
class SerializationBenchmark {
    ...
    data class BenchmarkResult(
        ...
        fun toCsvRow(): String =
            "$operation,$dataType,$format,$iterations,$totalTimeNanos,$averageTimeNanos,$averageTimeMicros,$averageTimeMillis"
     ...
     */
    private fun <T> convertToPlainObject(
        data: T,
    ...
    fun <T> benchmarkSerialization(
        ...
        val externalJson5SerializationTime =
            measureNanoTime {
                repeat(iterations) {
    ...
    fun <T> benchmarkDeserialization(
        ...
        val externalJson5DeserializationTime =
            measureNanoTime {
                repeat(iterations) {
