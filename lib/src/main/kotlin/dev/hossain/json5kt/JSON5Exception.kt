...
class JSON5Exception(
    ...
    companion object {
         ...
         */
        fun invalidEndOfInput(
            line: Int,
            col: Int,
        ): JSON5Exception = JSON5Exception("invalid end of input", line, col)

        /**
         * Create an exception for invalid identifier character.
         */
        fun invalidIdentifierChar(
            line: Int,
            col: Int,
        ): JSON5Exception = JSON5Exception("invalid identifier character", line, col)
    }
}
