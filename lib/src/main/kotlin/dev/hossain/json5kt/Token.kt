...
sealed class Token(
    ...
    class NullToken(
        line: Int,
        column: Int,
    ) : Token(TokenType.NULL, null, line, column)
    ...
    class BooleanToken(
        ...
        line: Int,
        column: Int,
    ) : Token(TokenType.BOOLEAN, boolValue, line, column)
    ...
    class StringToken(
        ...
        line: Int,
        column: Int,
    ) : Token(TokenType.STRING, stringValue, line, column)
    ...
    class NumericToken(
        ...
        line: Int,
        column: Int,
    ) : Token(TokenType.NUMERIC, numberValue, line, column)
    ...
    class PunctuatorToken(
        val punctuator: String,
        line: Int,
        column: Int,
    ) : Token(TokenType.PUNCTUATOR, punctuator, line, column)
    ...
    class IdentifierToken(
        ...
        line: Int,
        column: Int,
    ) : Token(TokenType.IDENTIFIER, identifierValue, line, column)
    ...
    class EOFToken(
        line: Int,
        column: Int,
    ) : Token(TokenType.EOF, null, line, column)
}
